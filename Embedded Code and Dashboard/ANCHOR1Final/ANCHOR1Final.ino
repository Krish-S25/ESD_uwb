...
// Anchor 1 position: (0, 2.3, 1.42) — mounted at wall, height 1.42 m  [id = 1]
// Hub      position: (1.45, 0, 1.42)
// Anchor 2 position: (2.45, 3.04, 1.42)                                  [id = 3]
// -------------------------------------------------------
#include <SPI.h>
#include <WiFi.h>
#include <esp_now.h>
...
void setup() {
    ...
    Serial.println("Anchor 1 at (0, 2.3, 1.42) Ready");
}
...
void loop() {
    ...
    // =============================================================
    // TIME SLOT 1 of 3  (600 ms shared cycle)
    // Anchor 1 ranges immediately at 0ms from SYNC.
    // =============================================================
    ...
    if (status_reg & SYS_STATUS_RXFCG_BIT_MASK) {
        ...
        if (frame_len <= sizeof(rx_buffer)) {
            ...
            if (memcmp(rx_buffer, rx_resp_msg, ALL_MSG_COMMON_LEN) == 0) {
                ...
                Serial.print("Sent D_A1: "); Serial.print(dist, 2); Serial.println(" m");
            }
        }
    } else {
        dwt_write32bitreg(SYS_STATUS_ID, SYS_STATUS_ALL_RX_TO | SYS_STATUS_ALL_RX_ERR);
        Serial.println("Anchor 1: No response");
    }
}